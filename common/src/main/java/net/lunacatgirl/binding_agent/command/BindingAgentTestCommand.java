package net.lunacatgirl.binding_agent.command;
...
import net.lunacatgirl.binding_agent.api.attachment.PlayerAttachments;
import net.lunacatgirl.binding_agent.debug.BindingAgentDebug;
